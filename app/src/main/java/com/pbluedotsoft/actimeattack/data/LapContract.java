...
public class LapContract {
     ...
     */
    public static final String CONTENT_AUTHORITY = "com.pbluedotsoft.actimeattack";
    ...
    public static final class LapEntry implements BaseColumns {
        ...
        public static final String COLUMN_LAP_TOP_SPEED = "speed";
